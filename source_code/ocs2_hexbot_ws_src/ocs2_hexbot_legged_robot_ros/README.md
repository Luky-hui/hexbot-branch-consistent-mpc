...
- 默认 Python launch 入口是 `hexbot_sqp.launch.py`，但当前默认 solver 已切到 `ipm`
...
```bash
ros2 launch ocs2_hexbot_legged_robot_ros hexbot_sqp.launch.py solver:=ipm
ros2 launch ocs2_hexbot_legged_robot_ros hexbot_sqp.launch.py solver:=sqp
```
```
