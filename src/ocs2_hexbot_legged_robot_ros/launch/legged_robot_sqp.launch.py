...
def generate_launch_description():
    ...
    ld = launch.LaunchDescription(
        [
            ...
            launch.actions.DeclareLaunchArgument(
                name="cmdVelTimeout", default_value="2.0"
            ),
            launch.actions.DeclareLaunchArgument(
                name="lockNominalHeightToObservation", default_value="true"
            ),
            launch.actions.DeclareLaunchArgument(
                name="lockResetHeightToObservation", default_value="true"
            ),
            launch.actions.DeclareLaunchArgument(
                name="translationLookaheadTime", default_value="0.35"
            ),
            launch.actions.DeclareLaunchArgument(
                name="rotationLookaheadTime", default_value="0.50"
            ),
